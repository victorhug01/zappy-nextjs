    ...
    <>
      ...
      <form className="w-full sm:max-w-lg grid place-items-center gap-4">
        <div className="w-full text-center grid gap-10 mb-6">
          ...
          <p className="text-foreground-default text-center">Crie sua conta de forma segura e<br/>rápida</p>
        </div>
        <div className="w-full grid gap-5 mb-6">
            <label className="floating-label w-full">
                <input type="text" placeholder="Name" className="input input-lg bg-foreground-inverse border-foreground-default border-[1.5px] sm:border-2 rounded-[10px] text-foreground-default w-full h-14 md:h-12 text-base" />
                <span className="!bg-foreground-inverse text-primary">Name</span>
            </label>
            
            <label className="floating-label w-full">
                <input type="text" placeholder="Email" className="input input-lg bg-foreground-inverse border-foreground-default border-[1.5px] sm:border-2 rounded-[10px] text-foreground-default w-full h-14 md:h-12 text-base" />
                <span className="!bg-foreground-inverse text-primary">Email</span>
            </label>

            <label className="floating-label w-full">
                <Input type="password" placeholder="Password" className="input input-lg bg-foreground-inverse border-foreground-default border-[1.5px] sm:border-2 rounded-[10px] text-foreground-default w-full h-14 md:h-12 text-base" />
                <span className="!bg-foreground-inverse text-primary">Password</span>
            </label>

            <label className="floating-label w-full">
                <Input type="password" placeholder="Confirm Password" className="input input-lg bg-foreground-inverse border-foreground-default border-[1.5px] sm:border-2 rounded-[10px] text-foreground-default w-full h-14 md:h-12 text-base" />
