...
export default function HomeClient() {
    return (
        <div>
            <header>
                <nav className="w-full h-16 flex bg-background fixed justify-between items-center px-3 overflow-x-hidden" aria-label="Navbar Desktop">
                    ...
                    <div className="hidden md:flex gap-3 w-full justify-end items-center">
                        <Link href={"/signUp"} className="font-medium border-2 border-foreground-default p-1.5 text-center rounded-md text-foreground-default hover:border-primary hover:text-primary hover:cursor-pointer w-26" aria-label="Botão de cadastro">Cadastre-se</Link>
                        <Link href={"/signIn"} className="font-medium bg-foreground-default hover:bg-primary text-center hover:text-foreground-default text-foreground-inverse border-2 border-foreground-default hover:border-primary p-1.5 rounded-md hover:cursor-pointer w-26" aria-label="Botão de login">login</Link>
                    </div>
                    <DrawerComponent/>
                </nav>
            </header>
            ...
            <main>
                <section className="w-full h-screen flex justify-center items-center pt-14 p-6" id="section1">
                    <div className="w-full sm:max-w-3xl flex flex-col items-center justify-center gap-16">
                        ...
                        <div className="w-full flex flex-col md:flex-row justify-center gap-4">
                            <Link href={"/signUp"} className="font-medium bg-foreground-default hover:bg-primary text-center hover:text-foreground-default text-foreground-inverse border-2 border-foreground-default hover:border-primary p-2.5 rounded-md hover:cursor-pointer w-full" aria-label="Botão de login">Comece sua jornada</Link>
                            <Link href={"/signIn"} className="font-medium border-2 border-foreground-default text-center rounded-md text-foreground-default hover:border-primary hover:text-primary hover:cursor-pointer p-2.5 w-full" aria-label="Botão de cadastro">Acesse seu espaço</Link>
                        </div>  
                    </div>
                </section>
